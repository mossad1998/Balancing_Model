...
extern void I2C_Mode_Function(int timer_number,char type[10]);                  //Unlock for port
...
extern void I2C_Scan_Address(int timer_number, int number_of_address_bit);          //General i/o or Alternative Function
